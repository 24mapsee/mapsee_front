          ...
          builder: (context, state) {
            return Column(
              children: [
                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildCategoryItem(
                              '음식점', 'assets/images/png/cutlery.png'),
                          _buildCategoryItem(
                              '카페', 'assets/images/png/coffee.png'),
                          _buildCategoryItem(
                              '병원', 'assets/images/png/medical.png'),
                          _buildCategoryItem(
                              '편의점', 'assets/images/png/convenience.png'),
                          _buildCategoryItem(
                              '마트', 'assets/images/png/mart.png'),
                          _buildCategoryItem(
                              '주차장', 'assets/images/png/parking.png'),
                        ],
                      ),
                    ),
                  ),
                ...
                if (_isTyping &&
                    (state is SearchFilterSearchingState ||
